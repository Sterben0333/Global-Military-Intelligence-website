...
(function initCustomCursor() {
    ...
    // Smoothly move the ring with lerp
    function animate() {
    ...
    const hoverSelectors = 'a, button, [onclick], .nation-card, .conflict-card, .compare-nation-card, .news-card, .nav-link, .conquest-tab, .alliance-filter, .featured-btn, .hero-cta, .filter-btn, .category-btn, select, .scroll-indicator';
    const textSelectors = 'input[type="text"], input[type="search"], textarea, [contenteditable="true"]';
    const mapSelectors = '#conquest-map, #conflict-map, .leaflet-container';
    ...
    document.addEventListener('mouseover', function (e) {
        ...
        // Check maps first
        if (target.closest(mapSelectors)) {
        ...
        if (target.matches(textSelectors)) {
            ...
            dot.classList.remove('cursor-hover', 'cursor-hidden');
            ring.classList.remove('cursor-hover', 'cursor-hidden');
            return;
        }
        ...
        if (target.closest(hoverSelectors)) {
            ...
            dot.classList.remove('cursor-text', 'cursor-hidden');
            ring.classList.remove('cursor-text', 'cursor-hidden');
            return;
        }

        // Default
        dot.classList.remove('cursor-hover', 'cursor-text', 'cursor-hidden');
        ring.classList.remove('cursor-hover', 'cursor-text', 'cursor-hidden');
    });
